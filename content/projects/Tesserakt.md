...
{{< figure src="/img/project/tesserakt-construction.png" title="Konstruktion eines Tesserakts" >}}
...
2D-Rotationsmatrix für Rotationen in einer Ebene XY ist: $\gdef\ma{\boldsymbol}$
...
## Simulation
Nachdem das Programm <a href="/files/Tesserakt.jar">Tesserakt.jar</a> mit Java (JRE) gestartet wurde, öffnet sich das Hauptfenster. Auf der
