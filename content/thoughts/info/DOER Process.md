...
2. **Organize**: Once you have time, organize each item left into its correct list/location:
	1. Planner: For action items. Sort into *check, do, plan*. Tag projects.
	2. Calendar: For reminders, recurring events, meetings, events
	3. Incubator: For goals, ideas, visions, leads, jots
	4. Library: Fora articles, books, ideas, resources
	5. Maybe Someday: Keep it safe, in case you need it.
3. **Engage**: Execute a task or Express/Export information in own words. 
4. **Review/Reflect**: 
	* Daily: Get your inbox to zero. Review tasks that depend on others or Reduce information. 
	* Weekly: Update your lists/info. 

## Workflow Details
### 1. Dump: Get it out of your brain 
Dumping allows you to get something off your mind quickly. When a thought outside the current context hits your brain, it is exhausting to keep it present in the background. It is likely that you either forget the thought or it interferes with your current thinking context. Therefore, you should transfer any new input into your **inbox** within few seconds. This inbox needs to be available in any context.
...
* https://danielkestenholz.com/minimalist-productivity-system/
